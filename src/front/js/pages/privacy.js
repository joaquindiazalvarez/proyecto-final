...
export const Privacy = () => {
  return (
    <div className="privicyDiv">
      <div>
        <h4 className="mb-5">Politicas de privacidad</h4>
      </div>
      <div>
        <h3>1. INFORMACION AL USUARIO</h3>

        <p>
          <strong>Juan Fernandez Gil</strong>, en adelante RESPONSABLE, es el
          Responsable del tratamiento de los datos personales del Usuario y le
          informa que estos datos serán tratados de conformidad con lo dispuesto
          en el Reglamento (LATAM) 2016/679 de 27 de abril de 2016 (GDPR)
        ...
        <p>
          <strong>Fin del tratamiento:</strong> mantener una relación comercial
          con el Usuario. Las operaciones previstas para realizar el tratamiento
          son:
        </p>

        <ul>
          <li>
            Remisión de comunicaciones comerciales publicitarias por email, fax,
            SMS, MMS,comunidades sociales o cualquier otro medio electrónico o
            físico, presente o futuro, que posibilite realizar comunicaciones
            comerciales. Estas comunicaciones serán realizadas por el
            RESPONSABLE y relacionadas sobre sus productos y servicios, o de sus
            colaboradores o proveedores con los que éste haya alcanzado algún
            acuerdo de promoción. En este caso, los terceros nunca tendrán
          ...
          <li>
            ...
            contacto que se ponen a su disposición.
          </li>
        ...
        <p>
          ...
          tratamiento y cuando ya no sea necesario para tal fin, se suprimirán
          con medidas de seguridad adecuadas para garantizar la seudonimización
        ...
        <ul>
          ...
          <li>
            ...
            (PDI) si considera que el tratamiento no se ajusta a la normativa
            vigente.
          </li>
        </ul>
        <p>
        ...
        <p>
          Direccion postal: Juan Fernandez Gil. Calle Santiago 365, 40001,
          Santiago, Region Metropolitana, Chile. Email:contacto@bandfolio.com
        </p>
      </div>
      <div>
        <h3>
        ...
        <p>
          ...
          los mismos. El RESPONSABLE informa y garantiza expresamente a los
          usuarios que sus datos personales no serán cedidos en ningún caso a
          terceros, y que siempre que realizara algún tipo de cesión de datos
          personales, se pedirá previamente el consentimiento expreso, informado
          e inequívoco por parte los Usuarios. Todos los datos solicitados a
