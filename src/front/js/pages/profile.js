...
export const Profile = () => {
  ...
  }, [params.name, editDescription, editPhoto, editSoundCloud, editName, editStatus]);
  return (
          ...
          <div className="">
            <div className="bg-light" style={{maxwidth: "1090px"}}>
              <div className="row container g-0">
                <div class="col-md-4 p-0 d-flex justify-content-center align-items-center" style={{maxHeight: "300px"}}>
                ...
                <div className="row">
                  {/*donate button----------------------------------------------------*/}
                    <div className="col-2 text-center ms-1">
                      <button className="btn btnDonate col-12" >
                        Donate
                      </button>
                    </div>
                  ...
                  {store.user_profile.name && (
                    <div className="ms-5 col-1">
                      ...
                      <input type="text" className="input-group-sm mb-3 form-control col me-4" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" 
                  ...
                  <div className="row">
                    <div className="player-wrapper col d-flex justify-content-end p-4 ">
                      <ReactPlayer width='50%' height='60%' url={store.profile.soundcloud} />
                    </div>
                  </div>
                  )}
                  {editSoundCloud && (
                ...
                <div className="">
                  {!editSoundCloud && (
                    ...
                    ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-disc-fill" viewBox="0 0 16 16">
